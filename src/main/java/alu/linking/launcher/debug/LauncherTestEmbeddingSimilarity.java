		...
		try {
			...
			try (final Scanner sc = new Scanner(System.in)) {
				do {
					...
					mentionsLeft = md.detect(InputProcessor.combineProcessedInput(InputProcessor.processToSingleWords(inputLine)));
					...
					mentionsRight = md.detect(InputProcessor.combineProcessedInput(InputProcessor.processToSingleWords(inputLine)));
