...
public class CandidateGeneratorMap implements CandidateGenerator<Node> {
	 ...
	 */
	@Override
	public List<PossibleAssignment<Node>> generate(Mention<Node> mention) {
		...
		final List<PossibleAssignment<Node>> ret = Lists.newArrayList();
