...
public class VectorRetriever {
	...
	public static void retrieveVectors(String modelInput, String inpuInstancesFile, String outputFile) {
			...
			try (Writer writer = new BufferedWriter(
				...
				while ((line = br.readLine()) != null) {
					...
					if (instances.contains(res)) {
						...
						foundInstances++;
						System.out.println("FOUND instances: " + foundInstances + " out of " + totalInstances);
					}
					if (instances.size() == 0)
						break;
				}
	...
	private static List<String> readInstances(String inpuInstancesFile) {
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				instances.add(line.replace("http://dbpedia.org/resource/", "dbr:"));
			}
